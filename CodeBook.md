...
Produced "merged_tidy_dataset.txt" with the combined data frame as the first expected output
...
Produced "calculated_tidy_dataset.txt" as the second expected output
